...
public class StockData {
    ...
    public StockData(String id, String quarter, String stock, String date, String open, String high, String low, String close, String volume, String percent_change_price, String percent_change_volume_over_last_wk, String previous_weeks_volume, String next_weeks_open, String next_weeks_close, Double percent_change_next_weeks_price, Integer days_to_next_dividend, Double percent_return_next_dividend) {
        this.id = id;
